...
function Intro({ivert, setinvert}) {
    ...
    return (
        <div id="particles-js" className='h-[calc(100%-5rem)] flex flex-col justify-center '>
            <div className='pt-24  px-2 flex flex-col items-center'>
                    <div className='flex mx-4 justify-center xl:mx-10 2xl:mb-4 lg:mb-8'>

                        <div className="lg:w-[80%] text-center 2xl:w-[70%] 2xl:mb-[200px] ">
                            <h1 data-aos="fade-down" className='xl:text-[32px] xl:mt-6 lg:leading-9 sm:text-[24px] sm:mb-8 text-[20px] leading-8 text-center'>
                            ...
                            <div className={`flex ${ivert && 'invert'} justify-center  sm:mt-4 xl:mt-6 mt-2`}>
